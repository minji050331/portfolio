...
students = {} #빈 딕셔너리 생성
students["문동은"] = [78, 74, 69] #학생의 이름은 키로 사용하고, 점수는 값으로 갖는 딕셔너리 데이터 추가
students["전재준"] = [96, 84, 91]
students["박연진"] = [93, 86, 75]
students["이사라"] = [64, 83, 84]
students["최혜정"] = [68, 61, 71]
students["손명오"] = [64, 59, 48]
students["김경란"] = [98, 99, 99]
students["윤소희"] = [89, 91, 87]
students["김수한"] = [87, 91, 78]
